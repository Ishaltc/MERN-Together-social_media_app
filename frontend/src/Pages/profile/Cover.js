...
export default function Cover({ cover, visitor ,photos}) {
  ...
  //managing cover picture width when it crop
      ...
      {coverPicture && (
        <div className="save_changes_cover">
          ...
          <div className="save_changes_right">
            <button className="orange_btn opacity_btn" onClick={()=>setCoverPicture("")}>Cancel</button>

            <button className="orange_btn" onClick={() => updateCoverPicture()}>
